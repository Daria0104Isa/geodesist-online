          ...
          <table style="width:100%; border-collapse: collapse; margin: 20px 0;">
            <thead>
              <tr style={{ backgroundColor: '#F0F4EF' }}>
                <th style={{ padding: '12px', textAlign: 'left', border: '1px solid #D4DCCD' }}>Характеристика</th>
                <th style={{ padding: '12px', textAlign: 'left', border: '1px solid #D4DCCD' }}>Допуск</th>
                <th style={{ padding: '12px', textAlign: 'left', border: '1px solid #D4DCCD' }}>Примечание</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td style={{ padding: '12px', border: '1px solid #D4DCCD', fontWeight: 500 }}>Погрешность положения пунктов ОГС</td>
              ...
              <tr style={{ backgroundColor: '#F9F7F3' }}>
                <td style={{ padding: '12px', border: '1px solid #D4DCCD', fontWeight: 500 }}>Погрешность высот пунктов</td>
              ...
              <tr>
                <td style={{ padding: '12px', border: '1px solid #D4DCCD', fontWeight: 500 }}>Погрешность плановых измерений</td>
              ...
              <tr style={{ backgroundColor: '#F9F7F3' }}>
                <td style={{ padding: '12px', border: '1px solid #D4DCCD', fontWeight: 500 }}>СКП измерения углов</td>
