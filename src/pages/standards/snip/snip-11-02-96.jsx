        ...
        content={`
          ...
          <table style="width:100%; border-collapse: collapse; margin: 20px 0;">
            <thead>
              <tr style={{ backgroundColor: '#F0F4EF' }}>
                <th style={{ padding: '12px', textAlign: 'left', border: '1px solid #D4DCCD' }}>Вид изысканий</th>
                <th style={{ padding: '12px', textAlign: 'left', border: '1px solid #D4DCCD' }}>Состав работ</th>
                <th style={{ padding: '12px', textAlign: 'left', border: '1px solid #D4DCCD' }}>Основные требования</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td style={{ padding: '12px', border: '1px solid #D4DCCD', fontWeight: 500 }}>Инженерно-геодезические</td>
              ...
              <tr style={{ backgroundColor: '#F9F7F3' }}>
                <td style={{ padding: '12px', border: '1px solid #D4DCCD', fontWeight: 500 }}>Инженерно-геологические</td>
              ...
              <tr>
                <td style={{ padding: '12px', border: '1px solid #D4DCCD', fontWeight: 500 }}>Инженерно-гидрометеорологические</td>
              ...
              <tr style={{ backgroundColor: '#F9F7F3' }}>
                <td style={{ padding: '12px', border: '1px solid #D4DCCD', fontWeight: 500 }}>Инженерно-экологические</td>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{ fontSize: '13px', margin: '8px 0 0' }}>Сбор архивных данных</p>
            </div>
            <div style={{
              background: '#F0F4EF',
              padding: '16px',
              ...
              <p style={{ fontSize: '13px', margin: '8px 0 0' }}>Натурные измерения</p>
            </div>
            <div style={{
              background: '#F0F4EF',
              padding: '16px',
              ...
              <p style={{ fontSize: '13px', margin: '8px 0 0' }}>Обработка данных</p>
            </div>
            <div style={{
              background: '#F0F4EF',
              padding: '16px',
              ...
              <p style={{ fontSize: '13px', margin: '8px 0 0' }}>Составление отчета</p>
            </div>
          </div>
